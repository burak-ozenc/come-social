...
namespace ComeSocial.Infrastructure.Migrations
{
    ...
    [Migration("20230123153924_0123231839")]
    partial class _0123231839
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComeSocial.Domain.SocialEventType.ComeSocialEventType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ComeSocialEventTypes", (string)null);
                });
            ...
            modelBuilder.Entity("ComeSocial.Domain.SocialEvent.SocialEvent", b =>
                {
                    b.OwnsMany("ComeSocial.Domain.SocialEventType.ValueObjects.SocialEventTypeId", "SocialEventTypes", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
